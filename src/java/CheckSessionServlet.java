    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<h1>Servlet CheckSessionServlet at " + request.getContextPath() 
                    +"</h1>");
            out.println("Username: " + session.getAttribute("Sessionusername") + "<p>");
            out.println("Password: " + session.getAttribute("Sessionpassword") + "<p>");
            out.println("<a href=\"" + request.getContextPath() +
            "/LogoutSessionServlet\">Logout the session page</a>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
